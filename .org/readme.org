...
This image enables the [[https://tomcat.apache.org/tomcat-9.0-doc/config/filter.html#CORS_Filter][Apache Tomcat CORS filter]] by default. To disable it (maybe you want to handle CORS uniformly in a proxying webserver?), set environment variable ~DISABLE_CORS~ to ~1~.
...
More information about this topic is available in the  [[https://tomcat.apache.org/tomcat-9.0-doc/realm-howto.html#Digested_Passwords][Tomcat documentation]].
