...
Then augment the ~server.xml~ from this repository with this additional XML snippet for [[https://tomcat.apache.org/tomcat-11.0-doc/ssl-howto.html][Tomcat SSL capability]]:
